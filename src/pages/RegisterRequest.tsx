          ...
          <>
            ...
            <div className="bg-surface-muted backdrop-blur-3xl border border-border p-8 sm:p-12 rounded-[3.5rem] shadow-[0_32px_128px_rgba(0,0,0,0.2)] relative overflow-hidden">
              ...
              <form onSubmit={handleSubmit} className="space-y-8 relative z-10">
                ...
                <div className="space-y-3">
                  <label className="text-[10px] font-black text-text-dim uppercase tracking-[0.2em] ml-2">Email (optional)</label>
                  <div className="relative group">
                    <div className="absolute inset-y-0 left-0 pl-7 flex items-center pointer-events-none">
                      <Mail className="w-5 h-5 text-text-dim group-focus-within:text-accent transition-all duration-500" />
                    </div>
                    <input
                      type="email"
                      value={email}
